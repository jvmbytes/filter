...
class JDKBehaviorFeature extends ModifierFeature {
    ...
    JDKBehaviorFeature(Method method) {
        super(method.getModifiers());
    }

    JDKBehaviorFeature(Constructor constructor) {
...
public class JDKClassStructure extends FamilyClassStructure {
    ...
    public JDKClassStructure(final Class<?> clazz) {
        this.clazz = clazz;
    }
    ...
    private BehaviorStructure newBehaviorStructure(final Constructor constructor) {
        return new BehaviorStructure(
                new JDKBehaviorFeature(constructor),
                "<init>",
                this,
                this,
    ...
    public Feature getFeature() {
        return new JDKClassFeature(clazz);
    }
